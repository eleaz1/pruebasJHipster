...
@NgModule({
    imports: [
        ...
        PruebasJHipsterSharedModule.forRoot(),
        PruebasJHipsterCoreModule,
        PruebasJHipsterHomeModule,
        PruebasJHipsterAccountModule,
